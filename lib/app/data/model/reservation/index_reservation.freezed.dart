...
mixin _$IndexReservation {
 ...
 int get id;@JsonKey(name: 'user_id') int? get userId;@JsonKey(name: 'room_id') int get roomId;@JsonKey(name: 'reservation_code') String get reservationCode;@JsonKey(name: 'customer_ktp_card') String? get customerKtpCard;@JsonKey(name: 'start_date') String get startDate;@JsonKey(name: 'duration_month') int get durationMonth;@JsonKey(name: 'room_price') String get roomPrice;@JsonKey(name: 'admin_fee') String get adminFee; String get deposit;@JsonKey(name: 'total_price') String get totalPrice; String get status;// @JsonKey(name: 'payment_due_at')
// String? paymentDueAt,
//
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,roomId,reservationCode,customerKtpCard,startDate,durationMonth,roomPrice,adminFee,deposit,totalPrice,status,statusLabel);

@override
String toString() {
  return 'IndexReservation(id: $id, userId: $userId, roomId: $roomId, reservationCode: $reservationCode, customerKtpCard: $customerKtpCard, startDate: $startDate, durationMonth: $durationMonth, roomPrice: $roomPrice, adminFee: $adminFee, deposit: $deposit, totalPrice: $totalPrice, status: $status, statusLabel: $statusLabel)';
}
...
@useResult
$Res call({
 int id,@JsonKey(name: 'user_id') int? userId,@JsonKey(name: 'room_id') int roomId,@JsonKey(name: 'reservation_code') String reservationCode,@JsonKey(name: 'customer_ktp_card') String? customerKtpCard,@JsonKey(name: 'start_date') String startDate,@JsonKey(name: 'duration_month') int durationMonth,@JsonKey(name: 'room_price') String roomPrice,@JsonKey(name: 'admin_fee') String adminFee, String deposit,@JsonKey(name: 'total_price') String totalPrice, String status,@JsonKey(name: 'status_label') String statusLabel
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'user_id')  int? userId, @JsonKey(name: 'room_id')  int roomId, @JsonKey(name: 'reservation_code')  String reservationCode, @JsonKey(name: 'customer_ktp_card')  String? customerKtpCard, @JsonKey(name: 'start_date')  String startDate, @JsonKey(name: 'duration_month')  int durationMonth, @JsonKey(name: 'room_price')  String roomPrice, @JsonKey(name: 'admin_fee')  String adminFee,  String deposit, @JsonKey(name: 'total_price')  String totalPrice,  String status, @JsonKey(name: 'status_label')  String statusLabel)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IndexReservation() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id, @JsonKey(name: 'user_id')  int? userId, @JsonKey(name: 'room_id')  int roomId, @JsonKey(name: 'reservation_code')  String reservationCode, @JsonKey(name: 'customer_ktp_card')  String? customerKtpCard, @JsonKey(name: 'start_date')  String startDate, @JsonKey(name: 'duration_month')  int durationMonth, @JsonKey(name: 'room_price')  String roomPrice, @JsonKey(name: 'admin_fee')  String adminFee,  String deposit, @JsonKey(name: 'total_price')  String totalPrice,  String status, @JsonKey(name: 'status_label')  String statusLabel)  $default,) {final _that = this;
switch (_that) {
case _IndexReservation():
return $default(_that.id,_that.userId,_that.roomId,_that.reservationCode,_that.customerKtpCard,_that.startDate,_that.durationMonth,_that.roomPrice,_that.adminFee,_that.deposit,_that.totalPrice,_that.status,_that.statusLabel);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id, @JsonKey(name: 'user_id')  int? userId, @JsonKey(name: 'room_id')  int roomId, @JsonKey(name: 'reservation_code')  String reservationCode, @JsonKey(name: 'customer_ktp_card')  String? customerKtpCard, @JsonKey(name: 'start_date')  String startDate, @JsonKey(name: 'duration_month')  int durationMonth, @JsonKey(name: 'room_price')  String roomPrice, @JsonKey(name: 'admin_fee')  String adminFee,  String deposit, @JsonKey(name: 'total_price')  String totalPrice,  String status, @JsonKey(name: 'status_label')  String statusLabel)?  $default,) {final _that = this;
switch (_that) {
case _IndexReservation() when $default != null:
return $default(_that.id,_that.userId,_that.roomId,_that.reservationCode,_that.customerKtpCard,_that.startDate,_that.durationMonth,_that.roomPrice,_that.adminFee,_that.deposit,_that.totalPrice,_that.status,_that.statusLabel);case _:
  return null;
...
@override@JsonKey(name: 'admin_fee') final  String adminFee;
